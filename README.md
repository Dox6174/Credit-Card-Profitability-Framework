...
| [`tech-support.ipynb`](./tech-support.ipynb) | Exploratory data analysis notebook — missingness structure, spend decomposition checks, Spearman correlation matrix, Pareto concentration curves, card-type segmentation, and exploratory modeling (PCA/GMM, proxy scoring, XGBoost ranker) that informed the final framework. |
